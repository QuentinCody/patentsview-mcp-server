 ...
 */
function wrapUserCode(searchSource, userCode, preamble) {
...
export function createExecuteTool(options) {
    const { prefix, catalog, openApiSpec, apiFetch, doNamespace, loader: rawLoader, stagingThreshold, timeout = 30_000, preamble, } = options;
